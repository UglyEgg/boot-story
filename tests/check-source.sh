...
test -x "$project_root/tests/fixtures/bin/systemd-analyze"
test -x "$project_root/tests/fixtures/bin/systemctl"
test -x "$project_root/tests/fixtures/bin/journalctl"
